    ...
    <!-- end of latest_content_gallery -->
      ...
      <div class="product_box margin_r35">
       <form action="add.jsp" method="get">
        ...
        <p class="price"><input type="hidden"  name="page"  value="finalfrontpage.jsp"/>
        <input type="hidden"  name="pid"  value="BE01TG"/>Price: Rs.60</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
    ...
    <div class="product_box margin_r35"><form action="add.jsp" method="get">
        ...
        <p class="price"><input type="hidden"  name="page"  value="finalfrontpage.jsp"/><input type="hidden"  name="pid"  value="DA01AC"/>Price: Rs.45</p>
        <p><a href="#">Detail</a> | <a href="#">Add to Cart</a></p>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
...
<input type="image" src="images/shop.png" alt="Submit"/>
    ...
    <div class="product_box"><form action="add.jsp" method="get">
        ...
        <div class="image_wrapper"> <a href="#"><img src="images/fruit3.jpg" alt="" width="190" height="120"/></a> </div>
         <p class="price"><input type="hidden"  name="page"  value="finalfrontpage.jsp"/><input type="hidden"  name="pid"  value="BE02NT"/>Price: Rs.20</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        ...
        <p class="price"><input type="hidden"  name="page"  value="finalfrontpage.jsp"/><input type="hidden"  name="pid"  value="BE02NT"/>Price: Rs.75</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box"><form action="add.jsp" method="get">
        ...
        <p class="price"><input type="hidden"  name="page"  value="finalfrontpage.jsp"/><input type="hidden"  name="pid"  value="BA06GB"/>Price: Rs.35</p>
        <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
