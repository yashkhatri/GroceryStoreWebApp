  ...
  <div id="content">
    ...
    <!-- end of latest_content_gallery -->
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Britannia VegCakes</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/bakery1.jpg" alt="" width="194" height="115" /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="bakery.jsp"/><input type="hidden"  name="pid"  value="BA01BC"/>Price: Rs.20</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Cadbury Cookies</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/bakery2.jpg" alt="" width="189" height="116" /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="bakery.jsp"/><input type="hidden"  name="pid"  value="BA02CC"/>Price: Rs.150</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box"><form action="add.jsp" method="get">
        <h3>Grandma's Raisin Cookies</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/bakery3.jpg" alt="" width="190" height="120" /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="bakery.jsp"/><input type="hidden"  name="pid"  value="BA03GC"/>Price: Rs.175</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Wheat  Bread</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/bakery4.jpg" alt="" width="190" height="120" /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="bakery.jsp"/><input type="hidden"  name="pid"  value="BA04WB"/>Price: Rs.20</p>
        <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Brown Bread</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/bakery5.jpg" alt="" width="190" height="120" /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="bakery.jsp"/><input type="hidden"  name="pid"  value="BA05BB"/>Price: Rs.25</p>
        <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box"><form action="add.jsp" method="get">
        <h3>Garlic Bread</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/bakery6.jpg" alt="" width="190" height="120" /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="bakery.jsp"/><input type="hidden"  name="pid"  value="BA06GB"/>Price: Rs.35</p>
        <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
