...
function v(f) {
    var isValid = false;
    var q = (f.pass.value);
    var p = (f.repass.value);
    if(p==q) {
      
      
      isValid = true;
    } else{alert("Passwords donot match");
    f.pass.focus();
      f.repass.select();}
...
<div id="wrapper">
  ...
  <div class="clear" style="z-index:+1000">
    <ul type="none"class="dropdown" style="z-index:+1000">
      ...
      <li><a href="viewcart.jsp" class="blue">My Shopping List </a>
         <li><a href="admin1.jsp" class="blue">Admin Home</a>
  ...
  <div id="content">
    ...
    <div class="content_section" style="width: 800px">
      ...
      <p>&nbsp;</p>
      <form onsubmit="return v(this);" action="registerservlet.jsp" method="get" >
        <table border="2" width="800px" cellspacing="1" cellpadding="1">
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                    <td>First Name</td>
                    <td><input type="text" name="customername_first" placeholder="Enter First name" required ="required"/></td>
                </tr>
                <tr>
                    <td>Second Name</td>
                     <td><input type="text" name="customername_second" placeholder="Enter Second name" required ="required"/></td>
                </tr>
              <tr>
                <td>Address</td>
                <td><textarea name="address" placeholder="Enter your complete address" row="2" cols="50" required ="required"></textarea>
                </td>
              </tr>
                
                <tr>
                    <td>Phone Number</td>
                    <td><input type="text" name="phone_number" pattern="[0-9]{10}" min="10" placeholder="Enter 10 digit phone number" required ="required"/></td>
               </tr>
                
               <tr>
                    <td>User Name</td>
                     <td><input type="text" name="usm" placeholder="Enter Desired Username" required ="required"/></td>
                ...
                <tr>
                    <td>Re-enter Password</td>
                     <td><input type="password" name="repass" placeholder="Re-enter Password"required ="required"/></td>
                </tr>
               <tr>
                    <td>E-mail ID</td>
                     <td><input type="email" name="email" placeholder="Enter Valid Email Address"required ="required"/></td>
                </tr>
