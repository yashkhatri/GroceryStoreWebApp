...
sb.append("  <div class=content_section>");
 ...
 sb.append("<table width=650 border=2 cellspacing=2 cellpadding=2>");
        sb.append("<tr>");
        sb.append("  <th scope=col>Customer_Id</th>");
          sb.append("<th scope=col>Customer_Name</th>");
          sb.append("<th scope=col>Customer_Email</th>");
           sb.append("<th scope=col>Customer_ContactNum</th>");
         sb.append("<th scope=col>Customer_Username</th>");
           sb.append("  <th scope=col>Customer_Password</th>");
