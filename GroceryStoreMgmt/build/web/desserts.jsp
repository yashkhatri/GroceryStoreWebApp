  ...
  <div id="content">
    ...
    <!-- end of latest_content_gallery -->
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Instant Dessert Mix</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/dessert1.jpg" alt="" width="190" height="120" /></a> </div>
         <p class="price"><input type="hidden"  name="page"  value="desserts.jsp"/>
        <input type="hidden"  name="pid"  value="DE01IM"/>Price: Rs.150</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Jodhpuri Moong Halwa</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/dessert2.jpg" alt="" width="190" height="121" /></a> </div>
         <p class="price"><input type="hidden"  name="page"  value="desserts.jsp"/>
        <input type="hidden"  name="pid"  value="DE02JH"/>Price: Rs.210</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box"><form action="add.jsp" method="get">
        <h3>ButterSctoch IceCream</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/dessert3.jpg" alt="" width="190" height="122" /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="desserts.jsp"/>
        <input type="hidden"  name="pid"  value="DE03BI"/>Price: Rs.95</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Choclate IceCream</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/dessert4.jpg" alt="" width="190" height="120" /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="desserts.jsp"/>
        <input type="hidden"  name="pid"  value="DE04CI"/>Price: Rs.210</p>
        <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Amul-Gulab Jamun Mix</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/dessert5.jpg" alt="" width="190" height="120" /></a> </div>
         <p class="price"><input type="hidden"  name="page"  value="desserts.jsp"/>
        <input type="hidden"  name="pid"  value="DE05AM"/>Price: Rs.110</p>
        <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box"><form action="add.jsp" method="get">
        ...
        <div class="image_wrapper"> <a href="#"><img src="images/dessert6.jpg" alt="" width="190" height="120" /></a> </div>
         <p class="price"><input type="hidden"  name="page"  value="desserts.jsp"/>
        <input type="hidden"  name="pid"  value="DE06CP"/>Price: Rs.60</p>
        <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
