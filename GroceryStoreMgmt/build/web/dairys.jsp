  ...
  <div id="content">
    ...
    <!-- end of latest_content_gallery -->
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        ...
        <div class="image_wrapper"> <a href="#"><img src="images/dairy1.jpg" alt="" width="190" height="120" /></a> </div>
        
        <p class="price"><input type="hidden"  name="page"  value="dairys.jsp"/><input type="hidden"  name="pid"  value="DA01AC"/>Price: Rs.45</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Amul-Lite MIlk</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/dairy2.jpg" alt="" width="190" height="120"  /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="dairys.jsp"/><input type="hidden"  name="pid"  value="DA02AM"/>Price: Rs.50</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box"><form action="add.jsp" method="get">
        <h3>Amul-Butter</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/dairy3.jpg" alt="" width="190" height="120"  /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="dairys.jsp"/><input type="hidden"  name="pid"  value="DA03AB"/>Price: Rs.15</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Amul Spiced Milk</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/dairy4.jpg" alt="" width="190" height="120"  /></a> </div>
       <p class="price"><input type="hidden"  name="page"  value="dairys.jsp"/><input type="hidden"  name="pid"  value="DA04AS"/>Price: Rs.15</p>
  <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Nestle Milk Whitener</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/dairy5.jpg" alt="" width="190" height="120"  /></a> </div>
       <p class="price"><input type="hidden"  name="page"  value="dairys.jsp"/><input type="hidden"  name="pid"  value="DA05NM"/>Price: Rs.10</p>
        <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box"><form action="add.jsp" method="get">
        <h3>Swiss Yogurt</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/dairy6.jpg" alt="" width="190" height="120"  /></a> </div>
         <p class="price"><input type="hidden"  name="page"  value="dairys.jsp"/><input type="hidden"  name="pid"  value="DA06SY"/>Price: Rs.20</p>
