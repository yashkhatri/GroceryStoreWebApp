    ...
    <div class="content_section" style="width: 800px">
      ...
      <p>&nbsp;</p>
        ...
        <table border="1" width="800px" cellspacing="1" cellpadding="1">
            <thead>
               <caption><strong>Login</strong></caption ></thead>
            <tbody>
                <tr>
                    <td>Username</td>
                ...
                <tr>
                    <td>password</td>
                    <td><input type="password" name="pass" size="20"/></td> <td><p style="color: #ff0033">Enter correct Password</p></td>
                </tr>
                <tr>
                    <td colspan=2"><input type="submit" name="submit" value="login"/></td>
                    <td><p><a href="register.jsp"<strong>Sign Up</strong></a></p></td>
