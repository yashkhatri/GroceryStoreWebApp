  ...
  <div id="content">
    ...
    <!-- end of latest_content_gallery -->
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Apple</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/fruit1.jpg" alt="" width="190" height="120" /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="fruits.jsp"/><input type="hidden"  name="pid"  value="FR01AE"/>Price: Rs.50</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Green Apple</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/fruit2.jpg" alt="" width="190" height="120"/></a> </div>
 <p class="price"><input type="hidden"  name="page"  value="fruits.jsp"/><input type="hidden"  name="pid"  value="FR02GA"/>Price: Rs.30</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box"><form action="add.jsp" method="get">
        <h3>Banana</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/fruit3.jpg" alt="" width="190" height="120"/></a> </div>
         <p class="price"><input type="hidden"  name="page"  value="fruits.jsp"/><input type="hidden"  name="pid"  value="FR03BA"/>Price: Rs.20</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Strawberry</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/fruit4.jpg" alt="" width="190" height="120" /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="fruits.jsp"/><input type="hidden"  name="pid"  value="FR04SY"/>Price: Rs.30</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        <h3>Papaya</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/fruit5.jpg" alt="" width="190" height="120"/></a> </div>
 <p class="price"><input type="hidden"  name="page"  value="fruits.jsp"/><input type="hidden"  name="pid"  value="FR05PA"/>Price: Rs.25</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box"><form action="add.jsp" method="get">
        <h3>Mango</h3>
        <div class="image_wrapper"> <a href="#"><img src="images/fruit6.jpg" alt="" width="190" height="120" /></a> </div>
 <p class="price"><input type="hidden"  name="page"  value="fruits.jsp"/><input type="hidden"  name="pid"  value="FR06MO"/>Price: Rs.45</p>
