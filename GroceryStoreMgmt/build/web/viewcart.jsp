  ...
  <div class="clear" style="z-index:+1000">
    <ul type="none"class="dropdown" style="z-index:+1000">
     ...
     <li><a href="beverages.jsp" class="green">Beverages</a>
      ...
      <li><a href="viewcart.jsp" class="blue">My Shopping List </a></li>
...
gt[i]=grandtotal;
   ...
   l=name;
    ...
    <tr><td><input type="hidden" name="itemid" value=<%=name%>><%=name%></td><td><%=dis.getString(2)%></td><td><input type="number"  min = "0" max ="100" style="width: 300px "  name="qty" value=<%=name1%> required></td><td><%=dis.getString(3)%></td><td><%=total%></td></tr>
