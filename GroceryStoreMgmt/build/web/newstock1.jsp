      ...
      <div id="newstock">
        ...
        <table align="center" width="331" height="197" cellpadding="2" cellspacing="2">
           <tr>
            ...
            <input type="text" name="pid" id="pid" required ="required"/></th>
          </tr>
          <tr>
            <th scope="col">Article No.</th>
            <th scope="col"><label for="anum"></label>
            <input type="text" name="anum" id="anum" required ="required"/></th>
          </tr>
          <tr>
            <td align="center"><strong>Item Name</strong></td>
            <td align="center"><label for="iname"></label>
            <input type="text" name="iname" id="iname" required ="required" /></td>
          </tr>
          <tr>
            <td align="center"><strong>Quantity</strong></td>
            <td align="center"><label for="qty"></label>
            <input type="text" name="qty" id="qty" required ="required"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <input type="text" name="mfgdt" id="mfg" required ="required"/></td>
          </tr>
          <tr>
            <td align="center"><strong>Expiry</strong></td>
            <td align="center"><label for="expiry"></label>
            <input type="text" name="expdt" id="expiry" required ="required" /></td>
          </tr>
        </table>
        <p>&nbsp;</p>
<p align="center">
