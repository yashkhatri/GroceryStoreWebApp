    ...
    <!-- end of latest_content_gallery -->
      ...
      <div class="product_box margin_r35">
       <form action="add.jsp" method="get">
        ...
        <p class="price"><input type="hidden"  name="page"  value="beverages.jsp"/>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        ...
        <p class="price"><input type="hidden"  name="page"  value="beverages.jsp"/><input type="hidden"  name="pid"  value="BE02NT"/>Price: Rs.75</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box">
        ...
        <p class="price"><input type="hidden"  name="page"  value="beverages.jsp"/>
            <input type="hidden"  name="pid"  value="BE03BC"/>Price: Rs.70</p>
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        ...
        <p class="price"><input type="hidden"  name="page"  value="beverages.jsp"/><input type="hidden"  name="pid"  value="BE04BG"/>Price: Rs.65</p>
        <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      <div class="product_box margin_r35"><form action="add.jsp" method="get">
        ...
        <p class="price"><input type="hidden"  name="page"  value="beverages.jsp"/><input type="hidden"  name="pid"  value="BE05CE"/>Price: Rs.25</p>
        <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
...
<input type="image" src="images/shop.png" alt="Submit"/>
      ...
      </div><div class="product_box"><form action="add.jsp" method="get">
        <h3>Tang-Orange </h3>
        <div class="image_wrapper"> <a href="#"><img src="images/beverages6.jpg" alt="" width="190" height="120"  /></a> </div>
        <p class="price"><input type="hidden"  name="page"  value="beverages.jsp"/><input type="hidden"  name="pid"  value="BE06TO"/>Price: Rs.65</p>
        <a href="#">Detail</a> |<strong>Add to Cart</strong>
        <p>
          <label><strong>Quantity   </strong></label>
          <select name="qty" id="qty">
