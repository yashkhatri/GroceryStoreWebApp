   ...
   if(temp==0){
    ...
    <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
     ...
     <form action="delete.jsp" method="get">
         ...
         <tr><td><input type="hidden" name="order" value="<%=rs.getInt(7)%>"><b>Order No.</b></td><td colspan="4"><%=i%></td><input type="hidden" name="pag" value="view1.jsp"/></tr>
         <td colspan="5"><input type="submit" name="wish" value="delete"/><input type="submit" name="wish" value="delet"/></td>
    ...
    <%}%>
    <tr><td><%=rs.getString(1)%></td><td><%=dis.getString(2)%></td><td><%=rs.getString(2)%></td><td><%=dis.getString(3)%></td><td><%=total%><input type="text"  name="pid" value=<%=rs.getString(1)%> /><input type="text" name="qty" value=<%=rs.getString(2)%> /></td></tr>
